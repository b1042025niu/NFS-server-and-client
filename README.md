...
```
![img](https://github.com/b1042025niu/NFS-server-and-client/blob/main/imgs/nfs_sever_status.png)
- 啟動 NFS 伺服器服務狀態
```
...
```
![img](https://github.com/b1042025niu/NFS-server-and-client/blob/main/imgs/nfs_etc.png)
## NFS 伺服器防火牆設定
- 允許客戶端通過防火牆
```
sudo ufw allow from [clientIP or clientSubnetIP] to any port nfs
```
![img](https://github.com/b1042025niu/NFS-server-and-client/blob/main/imgs/nfs_ufw.png)
- 檢查防火牆狀態
```
sudo ufw status
```
![img](https://github.com/b1042025niu/NFS-server-and-client/blob/main/imgs/nfs_ufw_status.png)
# NFS 客戶端安裝
## NFS 客戶端
- NFS 客戶端安裝
```
...
```
# 最終完成畫面
![img](https://github.com/b1042025niu/NFS-server-and-client/blob/main/imgs/nfs_f.png)
# 參考資料
